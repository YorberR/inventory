        ...
        <div class="subcont">
            ...
            <div class="form">
                <form action="../app/controller/AddController.php" method="POST">
                    ...
                    <input type="text" class="description" name="description" placeholder="Añade la descripción"></input>
                    <input type="text" class="price" placeholder="Añade el precio" name="price">
                    <button class="btn" type="submit" name="submit">Añadir producto al inventario</button>
                </form>
            </div>
        </div>
    </div>
